...
// creates a portable MO2 instance with directory structure and config
//
class CreatePortableCommand : public Command
{
protected:
  Meta meta() const override;
...
// lists all portable instances
//
class ListInstancesCommand : public Command
{
protected:
  Meta meta() const override;
  std::optional<int> runEarly() override;
